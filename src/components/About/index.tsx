    ...
    <section id="About" className="about__container">
      ...
      <div className="container">
        ...
        <div className="container-text">
          ...
          <p>
            My name is <span>Pedro</span>. For many years I've been fascinated
            by the world of drinks and mixology.
          </p>
          <p>
            At 27 years old, I decided to venture into bartending, dive in
            headfirst, and start my own bar catering service. I love surprising
            people with different combinations and flavors.
          </p>
          <p>
            The possibility of bringing my ideas to different events and venues
            excites me.
            <span>I want to make each occasion unique</span> and ensure people
            enjoy special moments with a drink in hand.
          </p>
          <p>
